...
func (instLogger *InstrumenterLogger) Tick() {
	instLogger.TotalExecutionDuration = runtimeNano()
	instLogger.TimerDuration = runtimeNano()
	instLogger.TimerDuration -= instLogger.TotalExecutionDuration
	instLogger.TotalExecutionDuration -= instLogger.StartTime
}
